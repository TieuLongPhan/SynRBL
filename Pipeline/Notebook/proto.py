...
s = "CC(=O)O"  # "CC[Si](C)(C)C"  # "c1ccc(P(=O)(c2ccccc2)c2ccccc2)cc1"
...
path = "./Data/Validation_set/{}/MCS/{}.json.gz".format("USPTO_test", "MCS_Impute")
...
print(rule_map['bond restriction'])
index = 478 
print(data[index])
