...
def main():
    ...
    # missing_results_largest  = find_graph_dict(msc_dict_path=f'{root_dir}/Data/MCS/largest_mcs.json.gz', save_path=f'{root_dir}/Data/MCS/Final_Graph_macth_largest.json.gz')
    # for key, _ in enumerate(missing_results_largest):
    #     missing_results_largest[key]['R-id'] = data[key]['R-id']
    #     missing_results_largest[key]['old_reaction'] = data[key]['reactions']
    # save_database(missing_results_largest, root_dir / 'Data/MCS/Final_Graph_macth_largest.json.gz')
