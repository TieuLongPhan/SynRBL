...
from SynRBL.SynVis import ReactionVisualizer  # Replace 'your_module' with the name of your Python file
...
class TestReactionVisualizer(unittest.TestCase):
    ...
    def test_plot_reactions(self):
        ...
        self.visualizer.plot_reactions(old_reaction_str, new_reaction_str, savefig=True, pathname = root_dir / 'Test/SynVis/Test.png')
