...
from SynRBL.SynRuleEngine import AutomaticSmilesExtraction  # Replace 'your_module' with the name of your Python file containing the RuleImputeManager class
...
class TestAutomaticSmilesExtraction(unittest.TestCase):
    ...
    def test_get_fragments(self):
        ...
        filtered = AutomaticSmilesExtraction.get_fragments(input_dict, mw=50, n_C=1, combination='union')
