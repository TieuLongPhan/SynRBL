...
class TestGraphMissingUncertainty(unittest.TestCase):
    ...
    def setUp(self):
        self.graph_data = [
            ...
            {'boundary_atoms_products': [{'C': 0}], 'smiles': ['C1=CC=CC=C1.C2=CC=CC=C2']},
        ...
        self.threshold = 2
        self.graph_missing_uncertainty = GraphMissingUncertainty(self.graph_data, self.threshold)
    ...
    def test_check_fragments(self):
        graph_uncertain = GraphMissingUncertainty.check_fragments(self.graph_data, self.threshold)
