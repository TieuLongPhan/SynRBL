...
class TestSyntheticRuleMatcher(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.matcher = SyntheticRuleMatcher(self.rule_dict, self.data_dict, select='best', ranking=False)
    ...
    def test_rank_solutions(self):
        ...
        ranked_solutions = SyntheticRuleMatcher.rank_solutions(solutions, ranking='longest')
        self.assertEqual(solutions, ranked_solutions)

    def test_remove_overlapping_solutions(self):
        # Test removing overlapping solutions
        solutions = [[{'smiles': 'C1=CC=CC=C1', 'Ratio': 1}], [{'smiles': 'C1=CC=CC=C1', 'Ratio': 1}]]
