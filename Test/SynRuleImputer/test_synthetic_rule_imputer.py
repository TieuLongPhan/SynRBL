...
class TestSyntheticRuleImputer(unittest.TestCase):
    ...
    def test_single_impute(self):
        ...
        missing_data = {'Diff_formula': {'C': 4, 'H': 4, 'Q': 0}, 'Unbalance': 'Products', 'reactants': 'C2H6', 'products': 'C2H6'}
        imputed_data = SyntheticRuleImputer.single_impute(missing_data, self.rule_dict)

        # Check if 'new_reaction' is added to the dictionary, which implies successful imputation
    ...
    def test_parallel_impute(self):
        ...
        missing_data_list = [
            {'Diff_formula': {'C': 4, 'H': 4}, 'Unbalance': 'Products', 'reactants': 'C2H6', 'products': 'C2H6'},
            {'Diff_formula': {'C': 3, 'H': 6}, 'Unbalance': 'Reactants', 'reactants': 'C2H6', 'products': 'C2H6'}
        ]
